    ...
    return (
        <div className={S.wrapper} style={themeState}>
            ...
            <div className={S.right}>
                <h1>About Me</h1>
                <p>My name is <a href="https://www.linkedin.com/in/yuvrajsoneja/" target='_blank'>Yuvraj Soneja</a>, and I am a web developer with a passion for creating visually stunning and functionally efficient websites.
                    ...
                    If you're looking for a web developer who can bring your ideas to life, then look no further! Please feel free to browse through my portfolio by clicking <a href="https://yuvrajportfolio.netlify.app/" target='_blank'>here</a> to see some of my past projects and get in touch if you have any questions or would like to discuss your project in more detail.
                </p>
            </div>
        </div>
    )
